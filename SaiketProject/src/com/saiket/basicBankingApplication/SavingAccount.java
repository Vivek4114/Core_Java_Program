...
public class SavingAccount extends Account {
	...
	public void deposite(double amount) {
		if (amount > 0) {
			balance += amount;
			System.out.println("Saving account " + amount + " is added Successfully..!");
			System.out.println("Available Amount is : " + balance);
		} else {
			System.out
					.println("the deposite opr is not perform because zero or less than zero amount is not deposite ");
		}
