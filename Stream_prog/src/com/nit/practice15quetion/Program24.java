...
18. Find all duplicate words in a sentence
...
19. Count total number of vowels in a string
...
20. Find the longest palindrome word in a sentence

Input:
"madam anna racecar java"
Output:
racecar
...
/* 8. Find all duplicate words in a sentence
...
public class Program24 {
	...
	public static void main(String[] args) {
		...
		List<String> collect = Arrays.stream(split).filter(w -> Collections.frequency(Arrays.asList(split), w ) > 1 ).distinct().collect(Collectors.toList());
